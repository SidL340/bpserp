    ...
    <div className="min-h-screen bg-slate-950 text-slate-100 p-6 space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <div className="bg-slate-900 p-5 rounded-2xl border border-slate-800 space-y-3 shadow-md">
          ...
          <p className="text-xl font-black text-white">BPS School ERP API</p>
          <div className="text-xs text-slate-400 space-y-1 font-mono">
            <div>Host: http://localhost:5000/api</div>
        ...
        <div className="bg-slate-900 p-5 rounded-2xl border border-slate-800 space-y-3 shadow-md">
          ...
          <div className="text-xs text-slate-400 space-y-1 font-mono">
            ...
            <div className="flex items-center justify-between">
              <span>Super Admin: <strong className="text-white text-[10px]">admin@bps.edu.np</strong></span>
              <button
                onClick={() => setShowAdminPass(!showAdminPass)}
                className="text-amber-400 hover:underline flex items-center gap-1 text-[11px]"
              >
                {showAdminPass ? <EyeOff size={12} /> : <Eye size={12} />}
                <span>{showAdminPass ? 'Admin@2083' : '••••••••'}</span>
              </button>
            </div>
          </div>
        </div>
        ...
        <div className="bg-slate-900 p-5 rounded-2xl border border-slate-800 space-y-3 shadow-md">
          ...
          <p className="text-xl font-black text-white">app.bps.edu.np</p>
          <div className="text-xs text-slate-400 space-y-1 font-mono">
      ...
      <div className="text-center py-6 text-xs text-slate-500 space-y-1 border-t border-slate-900">
        ...
        <p>© {new Date().getFullYear()} Brindawan Public School ERP • Secure Diagnostics System</p>
      </div>
    </div>
  );
}
