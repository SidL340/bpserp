...
export default function UserManagementPage() {
  ...
  const triggerStandalonePrint = (slips: any[]) => {
    ...
    const cardsHtml = slips
      .map((item) => {
        const qrUrl = `https://api.qrserver.com/v1/create-qr-code/?size=120x120&data=${encodeURIComponent('https://app.bps.edu.np/login')}`;
        return `
          <div class="card">
            <div class="card-header">
              <img src="/school_logo.png" class="seal" alt="Seal" />
              <div class="header-titles">
                <div class="nepali-title">बृन्दावन पब्लिक स्कूल, विश्रामपुर, रौतहट</div>
                <div class="eng-title">Brindawan Public School, Brindaban</div>
            ...
            <div class="card-footer">
              🌐 app.bps.edu.np/login • Scan QR to Install Mobile App
            </div>
          </div>
        `;
      })
    ...
    printWin.document.write(`
      ...
      <html>
        <head>
          <title>Student Credentials Slips - Brindawan Public School</title>
          <style>
            @page {
              size: A4 portrait;
              margin: 5mm;
                    ...
                    <div key={idx} className="border border-dashed border-[#1e3a5f] rounded-xl p-2.5 bg-white space-y-2 relative print-slip-card">
                      ...
                      <div className="flex items-center gap-2 border-b border-gray-100 pb-1.5">
                        ...
                        <div className="min-w-0 flex-1 text-center">
                          <h4 className="font-black text-[10px] text-[#1e3a5f] font-nepali tracking-tight leading-tight">बृन्दावन पब्लिक स्कूल, विश्रामपुर, रौतहट</h4>
                          <p className="text-[8px] font-bold text-gray-600 leading-none">Brindawan Public School, Brindaban</p>
                      ...
                      <div className="text-[7px] text-gray-500 border-t border-dashed border-gray-200 pt-0.5 text-center leading-none">
                        🌐 app.bps.edu.np/login • Scan QR to Install App
                      </div>
                    </div>
                  );
                })}
