...
export default function FinancialReportsPage() {
  ...
  return (
    <div className="space-y-6 pb-16">
      ...
      <div className="hidden print:block text-center border-b-2 border-[#0a3d31] pb-3 mb-4">
        <h2 className="text-xl font-black text-[#0a3d31]">
          {school?.nameNepali || SCHOOL_DEFAULTS.nameNepali}
        </h2>
        <p className="text-xs font-bold text-gray-700">
          {school?.name || SCHOOL_DEFAULTS.name} • {school?.address || SCHOOL_DEFAULTS.address} (EMIS: {school?.emisCode || SCHOOL_DEFAULTS.emisCode})
        </p>
