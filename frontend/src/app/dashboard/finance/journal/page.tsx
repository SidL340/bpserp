...
export default function JournalVoucherPage() {
  ...
  const triggerJournalLedgerPrint = () => {
    ...
    const schoolName = school?.name || SCHOOL_DEFAULTS.name;
    const schoolNameNepali = school?.nameNepali || SCHOOL_DEFAULTS.nameNepali;
    const schoolAddress = school?.address || SCHOOL_DEFAULTS.address;
    const emisCode = school?.emisCode || SCHOOL_DEFAULTS.emisCode;
              ...
              <div className="flex items-center justify-between border-b-2 border-[#1e3a5f] pb-4">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-[10px] text-gray-600">
                      {school?.address || SCHOOL_DEFAULTS.address} • EMIS Code: <b className="font-mono">{school?.emisCode || SCHOOL_DEFAULTS.emisCode}</b>
                    </p>
                  </div>
                </div>
