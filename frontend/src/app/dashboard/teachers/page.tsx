  ...
  return (
    <div className="space-y-6 pb-12">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
        ...
        <div className="rounded-2xl border border-gray-100 bg-white p-4 shadow-2xs">
          <span className="text-[11px] font-bold text-gray-400 uppercase">Full-Time Faculty (स्थायी)</span>
          <p className="text-2xl font-extrabold text-blue-700 mt-1">{rastriyaCount}</p>
          <p className="text-[11px] text-gray-500">पूर्णकालीन शिक्षक दरबन्दी</p>
        </div>
        <div className="rounded-2xl border border-gray-100 bg-white p-4 shadow-2xs">
          <span className="text-[11px] font-bold text-gray-400 uppercase">Contract & Part-Time (करार/आंशिक)</span>
          <p className="text-2xl font-extrabold text-amber-600 mt-1">{nijiCount}</p>
          <p className="text-[11px] text-gray-500">करार तथा आंशिक शिक्षक</p>
        </div>
      </div>
      ...
      <div className="flex flex-col sm:flex-row items-center gap-3 rounded-2xl border border-gray-100 bg-white p-4 shadow-2xs">
        ...
        <div className="flex items-center gap-2 w-full sm:w-auto">
          ...
          >
            ...
            <option value="RASTRIYA">Full-Time (स्थायी)</option>
            <option value="NIJI_SROTH">Contract / Part-Time (करार/आंशिक)</option>
          </select>
        </div>
      </div>
              ...
              <div className="flex items-start justify-between gap-2">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    >
                      {teacher.type === 'RASTRIYA' ? 'स्थायी (Full-Time)' : 'करार / आंशिक (Contract)'}
                    </span>
                  </div>
                </div>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
                <div>
                  ...
                  <select name="type" required className="erp-input font-semibold">
                    <option value="RASTRIYA">स्थायी (Full-Time Faculty)</option>
                    <option value="NIJI_SROTH">करार / आंशिक (Contract / Part-Time)</option>
                  </select>
                </div>
                <div>
