...
export default function AttendancePage() {
  ...
  const triggerMonthlyMatrixPrint = () => {
    ...
    printWin.document.write(`
      ...
      <html>
        <head>
          <title>Monthly Attendance Register Book - Brindawan Public School</title>
          <style>
  ...
  const triggerMonthlyAttendancePrint = () => {
    ...
    printWin.document.write(`
      ...
      <html>
        <head>
          <title>Monthly Attendance Ledger - Brindawan Public School</title>
          <style>
        ...
        <body>
          <div class="header">
            ...
            <div class="school-sub">Brindawan Public School, Brindaban Municipality, Nepal</div>
  ...
  const triggerYearlyAttendancePrint = () => {
    ...
    printWin.document.write(`
      ...
      <html>
        <head>
          <title>Annual Attendance Calculation Ledger - Brindawan Public School</title>
          <style>
            @page { size: A4 portrait; margin: 10mm; }
            * { box-sizing: border-box; -webkit-print-color-adjust: exact !important; print-color-adjust: exact !important; }
            body { font-family: -apple-system, BlinkMacSystemFont, "Segoe UI", Roboto, sans-serif; margin: 0; padding: 0; background: #fff; color: #111; }
