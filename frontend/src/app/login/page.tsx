...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-[#062c23] via-[#093d32] to-[#041a14] flex items-center justify-center p-4">
      {/* Background pattern */}
      ...
      <div className="relative w-full max-w-md">
        ...
        <div className="text-center mb-8">
          <div className="inline-flex items-center justify-center w-24 h-24 bg-white rounded-full shadow-2xl mb-4 p-2 ring-4 ring-amber-400/50">
            <img src="/school_logo.png" alt="Brindawan Public School Emblem" className="w-20 h-20 object-contain" />
          </div>
          <h1 className="text-3xl font-black text-white font-serif tracking-wide">Brindawan Public School ERP</h1>
          <p className="text-amber-300 mt-1 text-xs font-bold font-nepali">बृन्दावन पब्लिक स्कूल व्यवस्थापन प्रणाली</p>
        </div>

        {/* Login Card */}
        <div className="bg-white rounded-3xl shadow-2xl p-8 border border-white/20">
          <div className="text-center mb-6">
            <h2 className="text-xl font-extrabold text-[#0a3d31]">Sign In / लगइन गर्नुहोस्</h2>
          ...
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full pl-10 pr-4 py-3 border border-gray-300 rounded-xl focus:outline-none focus:ring-2 focus:ring-[#0a3d31] text-xs font-mono font-bold text-gray-900 bg-slate-50/50"
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full pl-10 pr-10 py-3 border border-gray-300 rounded-xl focus:outline-none focus:ring-2 focus:ring-[#0a3d31] text-xs font-mono text-gray-900 bg-slate-50/50"
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full bg-[#0a3d31] hover:bg-[#115e59] text-white py-3 rounded-xl font-bold text-xs shadow-md transition-all duration-200 disabled:opacity-60 flex items-center justify-center gap-2 mt-2"
            >
              {loading ? (
                <>
          ...
          <div className="mt-5 pt-4 border-t border-slate-100 space-y-2">
            <div className="flex items-center justify-between">
              <span className="text-[10px] font-bold text-slate-500 uppercase tracking-wider flex items-center gap-1">
                ...
                Quick Fill (क्लिक गरी छिटो लगइन गर्नुहोस्):
              </span>
            </div>
            <div className="grid grid-cols-2 gap-1.5 text-xs">
              <button
                ...
                className="flex items-center gap-2 p-2 rounded-xl border border-emerald-200 bg-emerald-50/60 hover:bg-emerald-100/90 transition text-left cursor-pointer"
              >
                <span className="text-sm">🛡️</span>
                <div>
                  <div className="font-bold text-emerald-950 text-[11px]">Admin (प्रशासक)</div>
                  <div className="text-[9.5px] text-emerald-700 font-mono">admin / admin123</div>
                </div>
              </button>
              <button
                type="button"
                onClick={() => fillCredentials('teacher', 'teacher123')}
                className="flex items-center gap-2 p-2 rounded-xl border border-teal-200 bg-teal-50/60 hover:bg-teal-100/90 transition text-left cursor-pointer"
              >
                <span className="text-sm">🎓</span>
                <div>
                  <div className="font-bold text-teal-950 text-[11px]">Teacher (शिक्षक)</div>
                  <div className="text-[9.5px] text-teal-700 font-mono">teacher / teacher123</div>
                </div>
              </button>
              <button
                type="button"
                onClick={() => fillCredentials('accountant', 'accountant123')}
                className="flex items-center gap-2 p-2 rounded-xl border border-amber-200 bg-amber-50/60 hover:bg-amber-100/90 transition text-left cursor-pointer"
              >
                <span className="text-sm">💰</span>
                <div>
                  <div className="font-bold text-amber-950 text-[11px]">Accountant (लेखा)</div>
                  <div className="text-[9.5px] text-amber-700 font-mono">accountant / accountant123</div>
                </div>
              </button>
              <button
                type="button"
                onClick={() => fillCredentials('student', 'student123')}
                className="flex items-center gap-2 p-2 rounded-xl border border-blue-200 bg-blue-50/60 hover:bg-blue-100/90 transition text-left cursor-pointer"
              >
                <span className="text-sm">🎒</span>
                <div>
                  <div className="font-bold text-blue-950 text-[11px]">Student (विद्यार्थी)</div>
                  <div className="text-[9.5px] text-blue-700 font-mono">student / student123</div>
                </div>
              </button>
            </div>
          </div>
        ...
        <div className="text-center text-emerald-200/80 text-xs mt-6 space-y-1">
          <p>© {new Date().getFullYear()} Brindawan Public School ERP • All rights reserved</p>
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/60 backdrop-blur-xs">
          <div className="relative w-full max-w-md rounded-2xl bg-white p-6 shadow-2xl space-y-4">
            <div className="flex items-center justify-between border-b border-gray-100 pb-3">
              <div>
                <h3 className="text-base font-extrabold text-[#0a3d31] flex items-center gap-2">
            ...
            {resetSubmitted ? (
              <div className="py-6 text-center space-y-3">
                ...
                <button
                  type="button"
                  onClick={() => setIsResetModalOpen(false)}
                  className="rounded-xl bg-[#0a3d31] text-white px-6 py-2 text-xs font-bold shadow-xs mt-2 hover:bg-[#115e59]"
                >
              ...
              <form onSubmit={handleResetRequestSubmit} className="space-y-3 text-xs">
                <div>
                  <label className="block font-bold text-gray-700 mb-1">
                    Your Username, Student ID, or Phone *
                  </label>
                  <input
                    type="text"
                    required
                    placeholder="e.g. 20830101, teacher.ram, or 98XXXXXXXX"
                ...
                <div className="flex items-center justify-end gap-2 pt-3 border-t border-gray-100">
                  ...
                  <button
                    ...
                    className="inline-flex items-center gap-1.5 rounded-xl bg-[#0a3d31] hover:bg-[#115e59] px-5 py-2 font-bold text-white shadow-xs transition disabled:opacity-50"
                  >
                    <Send size={13} />
