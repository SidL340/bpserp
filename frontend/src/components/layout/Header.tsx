...
export function Header({ onMenuClick }: HeaderProps) {
  ...
  const currentTitle = matchedPath ? pageTitles[matchedPath] : { title: 'BPS School ERP', subtitle: 'विद्यालय व्यवस्थापन' };
  ...
  return (
    <header className="sticky top-0 z-30 flex h-16 items-center justify-between border-b border-gray-200 bg-white px-4 md:px-6 shadow-sm">
      ...
      <div className="flex items-center gap-3">
        ...
        <div>
          <h1 className="text-lg font-black text-[#0a3d31] leading-tight">{currentTitle.title}</h1>
      ...
      <div className="flex items-center gap-3 md:gap-4">
        {/* Nepali Date Badge */}
        <div className="hidden sm:flex items-center gap-1.5 rounded-full bg-emerald-50 border border-emerald-200/60 px-3 py-1 text-xs font-bold text-[#0a3d31] shadow-2xs">
        ...
        <Link
          ...
          className="relative rounded-full p-2 text-gray-600 hover:bg-emerald-50 hover:text-[#0a3d31] transition-colors"
          title="Notices"
        >
          <Bell size={18} />
        ...
        <div className="relative" ref={dropdownRef}>
          <button
            ...
            className="flex items-center gap-2 rounded-xl p-1.5 hover:bg-emerald-50/60 transition-colors"
          >
            <div className="flex h-8 w-8 items-center justify-center rounded-full bg-[#0a3d31] text-white text-xs font-black shadow-sm">
            ...
            <form onSubmit={handleChangePasswordSubmit} className="space-y-4">
              ...
              <div className="flex items-center justify-end gap-2 pt-3 border-t border-gray-100">
                ...
                <button
                  ...
                  className="px-5 py-2 bg-[#0a3d31] hover:bg-[#115e59] text-white font-bold text-xs rounded-xl shadow-xs disabled:opacity-50 transition-colors"
                >
