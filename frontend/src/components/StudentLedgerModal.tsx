  ...
  const triggerStudentLedgerPrint = () => {
    ...
    printWin.document.write(`
      ...
      <html>
        ...
        <body>
          <div class="header">
            <img src="${school?.logoUrl || '/school_logo.png'}" style="width: 48px; height: 48px; object-fit: contain; margin-bottom: 3px;" alt="School Logo" />
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/75 backdrop-blur-xs">
      <div className="relative w-full max-w-4xl max-h-[92vh] overflow-y-auto rounded-2xl bg-white p-6 shadow-2xl space-y-4">
        ...
        <div className="printable-document border-2 border-[#0a3d31] p-6 rounded-2xl bg-white space-y-4 text-xs font-sans">
          {/* Header */}
          <div className="flex items-center justify-between border-b-2 border-[#0a3d31] pb-4">
            ...
            <div className="text-right space-y-1">
              <span className="inline-block bg-[#0a3d31] text-white font-extrabold px-3 py-1 rounded text-xs tracking-wider uppercase">
