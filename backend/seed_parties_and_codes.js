...
async function seedPartiesAndCodes() {
  ...
  const partiesData = [
    ...
    { name: 'Quality Paper & Stationers', nameNepali: 'क्वालिटी स्टेसनरी', partyType: 'VENDOR', panNo: '601234567', phone: '9851012345', address: 'Brindaban Municipality, Nepal' },
    { name: 'TechSolutions Nepal Suppliers', nameNepali: 'टेक सोलुसन्स नेपाल', partyType: 'SUPPLIER', panNo: '602345678', phone: '9841234567', address: 'Gaur, Nepal' },
    { name: 'Brindaban Local Municipality', nameNepali: 'विश्रामपुर गाउँपालिका', partyType: 'GOVT', panNo: '301234567', phone: '055-520111', address: 'Brindaban' },
  ];
  ...
  const bankAccountsData = [
    { accountName: 'School Operational Account (सञ्चालन खाता)', accountNo: '123000987654321', bankName: 'Rastriya Banijya Bank', branch: 'Brindaban Branch', type: 'Current' },
    ...
    { accountName: 'Internal Reserve & Development A/C (आन्तरिक विकास खाता)', accountNo: '999000888777666', bankName: 'Global IME Bank', branch: 'Brindaban Branch', type: 'Savings' },
    { accountName: 'Education & SIP Grant Account (शिक्षा तथा छात्रवृत्ति खाता)', accountNo: '112000554433221', bankName: 'Nepal Bank Limited', branch: 'Brindaban Branch', type: 'Current' },
  ];
